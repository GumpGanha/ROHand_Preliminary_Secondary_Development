...
def generate_launch_description():
    ...
    extern_pub_node = Node(
        ...
        remappings=[("/external_joint_states", "/rohand_left/external_joint_states"),
                    ("/external_external_joint_states","/rohand_left/external_external_joint_states")],
    )
